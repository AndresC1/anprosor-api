...
class StoreRemissionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'client_id' => 'required|numeric|exists:clients,id|min:1',
    ...
    public function messages(): array
    {
        return [
            ...
            'client_id.numeric' => 'El client_id debe ser un número entero',
            'client_id.exists' => 'El client_id seleccionado no existe',
            'client_id.min' => 'El client_id debe ser un número entero positivo',
